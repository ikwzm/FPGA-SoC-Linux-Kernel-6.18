...
1. run scripts/build-linux-6.18.0-armv7-fpga.sh (easy)
...
```console
shell$ git clone --depth 1 -b v6.18 git://git.kernel.org/pub/scm/linux/kernel/git/stable/linux-stable.git linux-6.18.0-armv7-fpga
```

##### Make Build Branch

```console
shell$ cd linux-6.18.0-armv7-fpga
shell$ git checkout -b linux-6.18.0-armv7-fpga refs/tags/v6.18
```
...
```console
shell$ patch -p1 < ../patches/linux-6.18.0-armv7-fpga.diff
...
```console
shell$ patch -p1 < ../patches/linux-6.18.0-armv7-fpga-usb-ulpi.diff
shell$ git add --all
...
```console
shell$ patch -p1 < ../patches/linux-6.18.0-armv7-fpga-builddeb.diff
shell$ git add --all
